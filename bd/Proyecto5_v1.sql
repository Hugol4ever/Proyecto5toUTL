...
out var_Id_Promocion int, in var_Precio_Promo double(10,2), in var_Id_Producto2 int)
begin
insert into Promociones (Precio_Promo, id_Producto2)
values (var_Precio_Promo, var_id_Producto2); set var_Id_Promocion = last_insert_id();
-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
