...
in var_Id_Huella int, in var_Huella blob, in var_Id_Foto int, in var_Foto blob,
...
in var_Saldo_Dis double, in var_Id_Usuario varchar(35), in var_Contrasenia varchar(20))
begin
update Huella set Huella = var_Huella where Id_Huella = var_Id_Huella;

update FotoCliente set Foto = var_Foto where Id_Foto = var_Id_Foto;
...
update Usuario set Contrasenia = var_Contrasenia where Id_Usuario = var_Id_Usuario;
end $$
Delimiter ;
-- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
