...
-- Vista Huella cliente-------------------------------------------------------------------------------------------------------------------------------------------------------
create view viewProdComprados as
select v.Id_Cliente1, v.Id_Venta, dv.Nombre, dv.Cantidad
from viewVenta v inner join viewDetaVenta dv using(Id_Venta);
select * from viewProdComprados;
-- -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
