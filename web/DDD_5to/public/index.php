...
<head>
    ...
    <title><?=Globals::$titulo?> | Panel Principal</title>

    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="font-awesome/css/font-awesome.css" rel="stylesheet">
    
    <!-- Custom CSS -->
    <link href="custom/sb-admin-2.css" rel="stylesheet">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?=Globals::$PgraficasA?>">Graficas Avanzadas</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?=Globals::$Pcontactanos?>"><i class="fa fa-envelope"></i> <span class="nav-label"> Contactanos </span><span class="label label-warning pull-right">16/24</span></a>
                    <li>
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="<?=Globals::$Pprofile?>" class="pull-left">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Graficar Informacion</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?=Globals::$PgraficasS?>">
                            <div class="panel-footer">
                                <span class="pull-left">Ver Detalles</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Tablas organizadas!</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?=Globals::$Ptabla?>">
                            <div class="panel-footer">
                                <span class="pull-left">Ver Detalles</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                                ...
                                <div class="ibox-content">
                                    <div>
                                        ...
                                        <h4>NYS report new data!
                                            <br/>
                                            <small class="m-r"><a href="<?=Globals::$PgraficasS?>"> Check the stock price! </a> </small>
                                        </h4>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('Bienvenid@ a tu panel administrativo' , 'Daily Developers Designe');
